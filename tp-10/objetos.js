...
let resultado=
persona.hasOwnProperty("documento");
return resultado;
}
...
function sonLaMismaPersona(persona1, persona2) {
    let esigual=persona1.nombre ===persona2.nombre && persona1.apellido === persona2.apellido
    && persona1.edad === persona2.edad && persona1.documento === persona2.documento;
    return esigual;
}
